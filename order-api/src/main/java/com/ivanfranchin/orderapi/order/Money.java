...
public final class Money {
  ...
  public static BigDecimal requireDatabaseValue(BigDecimal value, String field) {
  ...
  public static BigDecimal multiply(BigDecimal price, long quantity, String field) {
    if (quantity <= 0)
